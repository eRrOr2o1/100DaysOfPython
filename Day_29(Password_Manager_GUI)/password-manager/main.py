...
search = tk.Button(text="Search",width=13, command=find_password)
search.grid(row=1, column=2)

email_entry = tk.Entry(width=35)
email_entry.grid(row=2, column=1, pady=5, columnspan=2, sticky="EW")
...
add_button.grid(row=4, column=1, pady=5, columnspan=2, sticky="EW")
